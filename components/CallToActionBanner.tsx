  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-[994px] mx-auto px-4 text-center flex flex-col items-center justify-center">
        ...
        <Link
          href="/menu"
          className="w-auto h-auto px-4 py-2 md:w-[208px] md:h-[48px] rounded-lg flex items-center justify-center text-white text-base font-normal transition-colors duration-300 shadow-lg hover:shadow-xl font-raleway leading-[150%] tracking-[0%] bg-[#B31217] gap-[8px]"
        >
          Explore More &rarr;
        </Link>
      </div>
