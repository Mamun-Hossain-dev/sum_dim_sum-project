...
const OurStorySection = () => {
  return (
    <div className="w-full max-w-[1320px] mx-auto py-[80px] lg:py-[120px] relative px-4 lg:px-0">
      ...
      <div className="hidden lg:block xl:hidden">
        <div className="relative">
          {/* Story Section */}
          <div className="w-full max-w-[664px] bg-[#F7E7E8] rounded-[20px] p-8 lg:p-12 relative overflow-hidden">
          ...
          {/* Image Section positioned 84px down from the content container */}
          <div
            className="absolute w-full max-w-[512px] h-[300px] lg:h-[389px]"
            style={{
              top: "84px",
              right: "0px",
            }}
